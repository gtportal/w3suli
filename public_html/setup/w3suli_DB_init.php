...
global $MySqliLink, $Err; 
  ...
  {
    $HTMLkod .= "A <b>'AlapAdatok'</b> tábla elkészült.<br>";
  } else { 
    $Err=1; $HTMLkod .= "MySqli hiba ";
  }
...
global $MySqliLink, $Err; 
  ...
  if (mysqli_query($MySqliLink,$DropTableStr))
  {
    $HTMLkod = "Az <b>'FCsoportTagok'</b> tábla törlődött.<br>"; 
  } else { 
    $Err=1;  $HTMLkod = "MySqli hiba "; 
  }
...
global $MySqliLink, $Err; 
  ...
  // Alapértelmezett oldalak feltöltése
   $InsertIntoStr = "INSERT INTO `FelhasznaloCsoport` 
        ...
        (1, 'webmesterek', 'Webmesterek¡k csoportja');
       " ;
    if (!mysqli_query($MySqliLink,$InsertIntoStr))  {
       $HTMLkod .=  " MySqli hiba (" .mysqli_errno($MySqliLink). "): " . mysqli_error($MySqliLink);   $Err=1; 
    }  
...
global $MySqliLink, $Err; 
  ...
  if (mysqli_query($MySqliLink,$CreateTableStr))
  {
    $HTMLkod .= "A <b>'OLathatosag'</b> tábla elkészült.<br>";
  } else { 
    $Err=1; $HTMLkod .= "MySqli hiba ";
  } 
  return $HTMLkod;
...
global $MySqliLink, $Err; 
  ...
  if (mysqli_query($MySqliLink,$CreateTableStr))
  {
    $HTMLkod .= "A <b>'Oldalak'</b> tábla elkészült.<br>";
  } else { 
    $Err=1; $HTMLkod .= "MySqli hiba ";
  } 
  ...
  // Alapértelmezett oldalak feltöltése
   $InsertIntoStr = "INSERT INTO `Oldalak` 
    ...
    (10, 'ArchÃ­vum', 'Archivum', 1, 1, 'ArchÃ­vum', 'ArchÃ­vum', 1, 22, '', 'Archivum', ''),
    (11, 'Kieg. tartalom', 'kiegeszito_tartalom', 1, 1, '', '', 1, 52, '', '', ''),
    ...
    (15, 'MenÅ± plusz infÃ³k', 'menuplusz', 1, 1, '', '', 1, 54, '', '', '')
    " ;
    if (!mysqli_query($MySqliLink,$InsertIntoStr))  {
       $HTMLkod .=  " MySqli hiba (" .mysqli_errno($MySqliLink). "): " . mysqli_error($MySqliLink);   $Err=1; 
    }  
...
global $MySqliLink, $Err; 
  ...
  if (mysqli_query($MySqliLink,$CreateTableStr))
  {
    $HTMLkod .= "A <b>'OldalCikkei'</b> tábla elkészült.<br>";
  } else { 
    $Err=1; $HTMLkod .= "MySqli hiba ";
  } 
  return $HTMLkod;
